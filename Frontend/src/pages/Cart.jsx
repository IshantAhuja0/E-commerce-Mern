          ...
          <div className="p-6">
            <div className="mb-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-2xl font-bold text-black">${(getTotalPrice() * 1.08).toFixed(2)}</span>
              </div>
            ...
            <form className="space-y-4">
              ...
              <div className="pt-4">
                <button 
                  type="submit"
                  className="w-full bg-black text-white py-4 rounded-xl font-semibold hover:bg-gray-800 transition-all duration-200 hover:scale-105 mb-3"
                >
                ...
                <button 
                  type="button"
                  onClick={() => setShowPaymentPopup(false)}
                  className="w-full border border-gray-300 text-black py-3 rounded-xl font-semibold hover:bg-gray-50 transition-all duration-200"
                >
                  Cancel
                </button>
              </div>
        ...
        <div className="flex-1 w-full">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between space-y-2 sm:space-y-0">
            <div className="flex-1">
              <h3 className="font-semibold text-black text-lg mb-1 group-hover:text-gray-700 transition-colors duration-200">{item.name}</h3>
            ...
            <div className="font-bold text-black text-xl sm:text-lg">${(item.price * item.quantity).toFixed(2)}</div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                <ShoppingBag size={24} sm:size={28} className="text-black" />
                <div>
                  <h1 className="text-xl sm:text-2xl font-bold text-black">Shopping Cart</h1>
        ...
        {cartItems.length === 0 ? (
          <div className="text-center py-16">
            ...
            <button 
              ...
              className="bg-black text-white px-8 py-3 rounded-full hover:bg-gray-800 transition-all duration-200 hover:scale-105"
            >
              Continue Shopping
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="xl:col-span-2">
              <div className="mb-6">
                <h2 className="text-xl sm:text-2xl font-bold text-black mb-2">Your Items</h2>
            ...
            <div className="xl:col-span-1">
              <div className="sticky top-24">
                <div className="bg-gray-50 rounded-2xl p-4 sm:p-6 border border-gray-200">
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="border-t border-gray-300 pt-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-lg sm:text-xl font-bold text-black">${(getTotalPrice() * 1.08).toFixed(2)}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <button 
                    onClick={handleContinueShopping}
                    className="w-full border border-gray-300 text-black py-4 rounded-xl font-semibold hover:bg-gray-50 transition-all duration-200 hover:scale-105"
                  >
                    Continue Shopping
                  </button>
                </div>
