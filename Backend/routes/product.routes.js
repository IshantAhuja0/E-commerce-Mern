...
import { getProduct,addProduct, uploadImages, deleteProduct, deleteImages, updateProduct, getInitialProducts } from "../controllers/product.controller.js"
...
router.route("/getinitialproducts/:category").get(getInitialProducts); 
